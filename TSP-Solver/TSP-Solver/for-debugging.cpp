...
//unsigned long gen_total_calculation(int gN, int rN) {
//	unsigned long ans = 0;
//
//	// 1 x 1
...
//// Held-Karp Algorithm
//// Uses bitmask Backtracking to make algorithm Run Faster
//Path HeldKarpSingleThreadedString(vector<vector<double>> adj_mat, vector<int> parcel_arr, vector<int> point_arr, vector<string> name_arr) {
...
//	unordered_map<string, pair <double, unsigned int>> umap;
//
//	unsigned long subset_size = gen_total_calculation(parcel_arr.size(), point_arr.size());
...
//	// as what node it passed before reaching this subset.
//	// Node subsets are represented as set bits.
//	unordered_map<unsigned long long, pair <double, unsigned int>> umap;
//
//	unsigned long subset_size = gen_total_calculation(parcel_arr.size(), point_arr.size());
...
//
//	start = clock();
//	cout << endl << "One Held Karp String Method: " << endl;
//	ans = HeldKarpSingleThreadedString(adj_mat, parcel_arr, point_arr, name_arr);
//	cout << ans.toString() << endl;
//	stop = clock();
//	cout << "Time Taken: " << stop - start << "ms" << endl;
//
//	start = clock();
//	cout << endl << "One Held Karp Int Method: " << endl;
//	ans = HeldKarpSingleThreadedInt(adj_mat, parcel_arr, point_arr, name_arr);
//	cout << ans.toString() << endl;
//	stop = clock();
//	cout << "Time Taken: " << stop - start << "ms" << endl;
//
