...
//Path HeldKarpMultiThreadedOMP(vector<int>& parcel_arr, vector<int>& point_arr, vector<string>& name_arr) {
...
//
//	// 5. Get Answer
//	Path ans = HeldKarpMultiThreadedOMP(parcel_arr, point_arr, name_arr);
//
//	/*stop = clock();
