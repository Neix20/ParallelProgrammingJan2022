...
//
//				subset_arr[k + l - 2].reserve(binomialCoeff(gN, k) * binomialCoeff(rN, l));
//
...
//int main() {
//
//	//vector<int> parcel_arr = { 1, 3, 5, 7 };
//	//vector<int> point_arr = { 2, 4 };
//	//
//	//long start, stop;
//
//	//start = clock();
//
//	//vector<vector<SubsetObj>> subset_2d_arr = testFunc2(parcel_arr, point_arr);
//
//	//for (auto arr : subset_2d_arr) {
//	//	for (auto elem : arr) {
...
//
//	// 5. Get Answer
//	Path ans = HeldKarpMultiThreaded(adj_mat, parcel_arr, point_arr, name_arr);
//
