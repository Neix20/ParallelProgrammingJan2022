...
// We create a new function that takes in a SubsetObj and get the minimum value of the subset.
// This function is for parallelizing the for loop.
...
Path HeldKarpMultiThreadedParallelWindows(vector<int>& parcel_arr, vector<int>& point_arr, vector<string>& name_arr) {
	...
	// Parallelism using Microsoft PPL
